...
select nombre as "Nombre Jugador", puntos_por_juego as "Promedio Puntos" from jugadores ORDER BY "Promedio Puntos" DESC;
...
select ciudad , sum(campeonatos) as total_campeonatos from equipos group by ciudad order by total_campeonatos desc;
